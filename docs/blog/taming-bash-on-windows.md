...
description: For the uninitiated, you can now run a real bash prompt on Windows 10 Anniversary Update or higher. Let's try to make sense of what's going on with that! 
date: 2017-07-07
tags:
  - windows10 
  - wsl
