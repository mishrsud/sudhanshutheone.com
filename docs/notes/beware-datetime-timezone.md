...
description: The DateTime type isn't enough for an application that needs to work with different timezones. You want a consistent way of handling date/time on the server and on the client.
date: 2019-01-15
tags:
  - .NET Core
  - Datetime
